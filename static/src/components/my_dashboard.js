...
import { KpiCard } from "./kpi/kpi_card"
...
export class OwlMyDashboard extends Component {
    // Top Products
    ...
    async getMonthlySales(){
        ...
        const data = await this.orm.readGroup("sale.report", domain, ['date','state','price_total'],['date','state'], 
    ...
    async getPartnerOrders(){
        ...
        const data = await this.orm.readGroup("sale.report", domain, ['partner_id','price_total','product_uom_qty'],['partner_id'], 
...
OwlMyDashboard.template = "owl.OwlMyDashboard"
OwlMyDashboard.components = { KpiCard, ChartRenderer }

registry.category("actions").add("owl.dashboard_owl", OwlMyDashboard)